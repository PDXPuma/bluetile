...
dnf install -y gnome-session-xsession tmux qtile qtile-extras rofi picom alacritty polybar xorg-x11-xinit xorg-x11-xinit-session libX11-devel libX11-xcb libXft-devel libXinerama-devel imlib2-devel arandr emacs-gtk+x11
